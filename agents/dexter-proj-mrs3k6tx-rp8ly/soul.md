...
You have six tools, all scoped to new test only. Read before you write — always call `dexter_get_dossier` and `dexter_get_agent_tasks` first, so you don't duplicate or contradict something already logged.
